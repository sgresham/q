...
class TriggerListener:
    ...
    def just_decode(self, recognizer, audio):
        try:
            ...
            history_pattern = r'\b(conversation\s?history|chat\s?log)\b'
            ...
            if 'alfred' in output.lower(): 
                ...
                if re.search(history_pattern, output, re.IGNORECASE):
                    print("Yes sir! Here is the previous LLM History")
